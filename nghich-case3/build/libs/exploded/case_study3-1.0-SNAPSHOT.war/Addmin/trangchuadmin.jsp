                ...
                <div class="col-sm-6 col-md-4">
                    <div class="card"  style="width: 262px; height: 520px; margin-bottom: 55px">
                        ...
                        <div class="card-body">
                            ...
                            <button type="button" class="mb-03 btn btn-outline-danger" data-toggle="modal" data-target="#Update${iceCream.iceCreamId}">
                                Update
                            </button>
                            <!-- Button to Open the Modal Delete-->
                            <button type="button" class="mb-03 btn btn-outline-danger" data-toggle="modal" data-target="#exampleModalDelete${iceCream.iceCreamId}">
                                Delete
                            </button>
