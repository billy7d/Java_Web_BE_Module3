...
<table cellpadding="2" cellspacing="2" border="1">
    ...
    <c:forEach var="item" items="${sessionScope.cart}">
        ...
        <tr>
            ...
            <td><button type="submit"><a href="cart?action=increase&id=${item.iceCream.iceCreamId}">+</a></button>${item.quantity}
                <button type="submit"><a href="cart?action=remove&id=${item.iceCream.iceCreamId}">-</a></button></td>
